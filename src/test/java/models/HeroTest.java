...
public class HeroTest {
    ...
    public void heroObjectIsCorrectlyCreated_true() {
        Hero superHero = new Hero("Samurai", 26, "Super Coder", "Patience", "ForexTraders");
        assertEquals(true, superHero instanceof Hero);
    }

    @Test
    public void allHeroesContainsAllHeroes_true() {
        Hero superHero = new Hero("Samurai", 26, "Super Coder", "My Patience", "ForexTraders");
        Hero secondSuperHero = new Hero("Ilham", 21, "Super worker", "Patience", "Lawyers");
    ...
    public void getPublished_isFalseAfterInstantiation_false() {
        Hero eric = new Hero("Samurai", 26, "Super Coder", "My Patience", "ForexTraders");
    ...
    public void delete_deleteASpecificHero() throws Exception{
        ...
        Hero ilham = new Hero("Ilham", 20, "Super worker", "Patience", "Lawyers");
        eric.deleteHero();
    ...
    private Hero setUpNewHero(){
        return new Hero("Samurai", 26, "Super Coder", "My Patience", "ForexTraders");
    }
